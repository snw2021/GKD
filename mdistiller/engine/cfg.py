...
CFG.KD.LOSS = CN()
CFG.KD.LOSS.CE_WEIGHT = 1.0
CFG.KD.LOSS.KD_WEIGHT = 1.0
CFG.KD.WARMUP = 20
...
# GradientKD CFG
CFG.GradientKD = CN()
CFG.GradientKD.TEMPERATURE = 4.0
CFG.GradientKD.LOSS = CN()
CFG.GradientKD.LOSS.CE_WEIGHT = 1.0
CFG.GradientKD.LOSS.KD_WEIGHT = 1.0
CFG.GradientKD.WARMUP = 20
